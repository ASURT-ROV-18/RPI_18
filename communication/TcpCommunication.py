    ...
    def _accept(self, x=None, y=None):
        ...
        try:
            if self._videoStreamingEnable:
                ...
                self._pipeline2 = "v4l2src device=/dev/video1 ! image/jpeg, width=1280, height=720, framerate=60/1 ! rtpjpegpay ! multiudpsink clients="  + self._streamingIP + ":" + self._streamingPort3 + "," + self._streamingIP + ":" + self._streamingPort4 +" sync=false"
